...
with tab1:
    ...
    if submit_button and flag == 0:
        ...
        with open(r"C:\Users\User\Downloads\model (1).pkl", 'rb') as file:
            loaded_model = pickle.load(file)
        with open(r"C:\Users\User\Downloads\scaler (1).pkl", 'rb') as f:
            scaler_loaded = pickle.load(f)

        with open(r"C:\Users\User\Downloads\t (1).pkl", 'rb') as f:
            t_loaded = pickle.load(f)

        with open(r"C:\Users\User\Downloads\s (1).pkl", 'rb') as f:
...
with tab2:
    ...
    if csubmit_button and cflag == 0:
        ...
        with open(r"C:\Users\User\Downloads\cmodel (1).pkl", 'rb') as file:
            cloaded_model = pickle.load(file)

        with open(r"C:\Users\User\Downloads\cscaler (2).pkl", 'rb') as f:
            cscaler_loaded = pickle.load(f)

        with open(r"C:\Users\User\Downloads\ct (1).pkl", 'rb') as f:
        ...
        # Select specific columns from new_sample using integer indexing
        selected_columns = new_sample[:, [0, 1, 2, 3, 4, 5, 6, 7]]

        # Concatenate the selected columns with new_sample_ohe
        new_sample = np.concatenate((selected_columns, new_sample_ohe), axis=1)
...
st.write(f'<h6 style="color:rgb(0, 153, 153,0.35);">App Created by Nivetha Eswaran</h6>', unsafe_allow_html=True)
